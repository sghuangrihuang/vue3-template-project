...
const fileList: any[] = [] // 用于存储上传的文件列表
</script>
...
<template>
  <div class="bugpage">
    ...
    <div class="bugpage-container">
      <div class="content">
        <h1>缺陷提交表单</h1>
        <el-form :model="bugForm" :rules="rules" ref="bugForm">
          ...
          <el-form-item label="附件上传" prop="attachment">
            <el-upload class="upload-drag-area" drag action="https://jsonplaceholder.typicode.com/posts/" multiple>
